(() => {
  ...
  const SEED_PIECES = [
    ...
    {id:'jester-dance', title:'Jester Dance', grades:[6,8], active:true},
    {id:'alpha-squadron', title:'Alpha Squadron', grades:[6,8], active:true},
    {id:'midnight-madness', title:'Midnight Madness', grades:[6], active:true},
    {id:'might-of-hercules', title:'The Might of Hercules', grades:[6], active:true},
    {id:'rise-of-bladesmith', title:'Rise of the Bladesmith', grades:[6], active:true},
    {id:'star-wars', title:'Star Wars', grades:[6], active:true},
    {id:'tenth-planet', title:'The Tenth Planet', grades:[6], active:true},
    {id:'shine', title:'Shine', grades:[6], active:true},
    {id:'falcons-flight', title:"Falcon's Flight March", grades:[6], active:true},
    {id:'mechanical-monsters', title:'Mechanical Monsters', grades:[6,7], active:true},
    {id:'wrath-mechanical', title:'Wrath of the Mechanical Monsters', grades:[6], active:true},
    {id:'tempest', title:'The Tempest', grades:[6], active:true},
    {id:'power', title:'Power', grades:[6], active:true},
    {id:'valiance', title:'Valiance', grades:[7], active:true},
  ...
  function renderInstruments(){
    app.innerHTML=`<button class="action secondary back" id="backPieces">← BACK</button><h2 class="screen-title">CHOOSE YOUR INSTRUMENT</h2><div class="chip-row"><span class="chip">${esc(state.name)}</span><span class="chip">${esc(state.piece.title)}</span></div><div class="grid instrument-grid">${INSTRUMENTS.map(i=>`<button class="pixel-button instrument" data-instrument="${esc(i)}">${esc(i)}</button>`).join('')}</div>`;
    document.getElementById('backPieces').onclick=renderPieces;
    app.querySelectorAll('[data-instrument]').forEach(b=>b.onclick=()=>{state.instrument=b.dataset.instrument;renderConfirm()});
  }
