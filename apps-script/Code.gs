...
const SEED_PIECES = [
  ['beginner','Beginner','6,7,8',true],
  ['power','Power','6,7,8',true],
  ['dragon-slayer','Dragon Slayer','6,7,8',true],
  ['alpha-squadron','Alpha Squadron','6,7,8',true],
  ['jester-dance','Jester Dance','6,7,8',true],
  ['midnight-madness','Midnight Madness','7,8',true],
  ['might-of-hercules','The Might of Hercules','7,8',true],
  ['rise-of-bladesmith','Rise of the Bladesmith','7,8',true],
  ['star-wars','Star Wars','7,8',true],
